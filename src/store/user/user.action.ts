...
>;
export type EmailSignInSuccess = ActionWithPayload<
  USER_ACTION_TYPES.SIGN_IN_SUCCESS,
  UserData
>;
export type EmailSingInFailed = ActionWithPayload<
...
export const signInSuccess = withMatcher(
  (user: UserData & { id: string }): EmailSignInSuccess =>
    createAction(USER_ACTION_TYPES.SIGN_IN_SUCCESS, user)
);

export const signInFailed = withMatcher(
  (error: Error): EmailSingInFailed =>
